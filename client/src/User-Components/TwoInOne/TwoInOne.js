...
function TwoInOne() {
  ...
  return (
    <div className="laptop-container">
      ...
      />
      <br />
      <h1 className="laptop-heading">The Best TwoInOne Laptops for 2025</h1>
      <br />
      <h3 className="laptop-description">
        ...
        life, and an affordable price—all in one sleek device. Perfect for work,
        study, and play!
      </h3>
      <br />
                  ...
                  <div className="product-info">
                    <div className="button-container">
                      <Link
                        ...
                        to={`/TwoInOneLaptopDetails/${laptops._id}`}
