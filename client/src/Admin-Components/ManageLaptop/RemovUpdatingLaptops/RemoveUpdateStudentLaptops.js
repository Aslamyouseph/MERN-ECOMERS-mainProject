...
function RemoveUpdateStudentLaptops() {
  ...
  return (
    <div>
      <br />
      <h1 className="Managing-heading">Remove or Update Student Laptops</h1>
            ...
            {laptops.map((laptop, index) => (
              <tr key={laptop._id}>
                ...
                <td>
                  ...
                  {/* Update Button */}
                  <Link
                    to={`/UpdateStudentLaptops/${laptop._id}`}
...
export default RemoveUpdateStudentLaptops;
