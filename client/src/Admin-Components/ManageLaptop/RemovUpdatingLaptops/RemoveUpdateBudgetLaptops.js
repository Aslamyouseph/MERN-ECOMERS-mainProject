...
function RemoveUpdateBudgetLaptops() {
  ...
  const handleDelete = async (laptop) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_BASE_URL}/api/admin/deleteBudgetLaptop/${laptop._id}`,
        {
          method: "DELETE",
          credentials: "include",
        }
  ...
  return (
    <div>
      <br />
      <h1 className="Managing-heading">Remove or Update Budget Laptops</h1>
...
export default RemoveUpdateBudgetLaptops;
