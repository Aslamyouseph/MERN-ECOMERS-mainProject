...
function AddingTwoInOne() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccessMessage("TwoInOne Laptop Added Successfully");
        // Reset form data
        setFormData({
          Laptop_title: "",
          Laptop_description: "",
        ...
        setError(data.message || "TwoInOne Laptop Adding failed. Try again.");
      }
    } catch (error) {
  ...
  return (
    <div className="laptop-form-container min-h-screen flex items-center justify-center py-8 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
      <div className="laptop-form bg-white shadow-xl rounded-lg w-3/4 sm:w-1/2 md:w-1/3 p-8">
        <h2 className="laptopName">Add the Latest TwoInOne Laptops</h2>
